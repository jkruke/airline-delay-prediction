...
python add-weather/add-weather-from-existing.py add-weather/data/weather.csv.gz data/history/flightsHistory-holidays.csv data/history/flightsHistory-weather.csv